#!/bin/bash
# PortMaster launch script for ytnative.
...
GAMEDIR="/$directory/ports/ytnative"
cd "$GAMEDIR"
...
export YTNATIVE_MAXHEIGHT=480

$GPTOKEYB "ytnative.${DEVICE_ARCH}" &
pm_platform_helper "$GAMEDIR/ytnative.${DEVICE_ARCH}"

./ytnative.${DEVICE_ARCH}
